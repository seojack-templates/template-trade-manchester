# template-trade-manchester

A standalone SEOJack website template. Lean Next.js 16 app (App Router, React 19,
scoped CSS — no Tailwind/Convex/Clerk).

- **Live:** https://trade-manchester.templates.seojack.website
- **Registry id:** `tpl_trade_manchester`
- **Showcased on:** https://seojack.net/templates/tpl_trade_manchester
...
| `app/styles.ts` | one scoped CSS literal (every selector prefixed `.trade-manchester-demo`) |
...
Own GitHub repo (`seojack-templates/template-trade-manchester`) + own Vercel project,
production domain `https://trade-manchester.templates.seojack.website`. See `docs/templates-github-org.md`.